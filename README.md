...
├── src/
│   ├── components/
│   │   └── SkillBadge.vue    # Reusable skill badge component
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/dj20kolkol02/portfolio.git
   cd portfolio
   ```
...
- **Particle Grid Background**: Animated background elements
...
- Icons by FontAwesome and Lucide
